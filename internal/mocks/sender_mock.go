...
// Source: github.com/ozonmp/est-water-api/internal/app/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 context.Context, arg1 *model.WaterEvent) error {
	m.ctrl.T.Helper()
