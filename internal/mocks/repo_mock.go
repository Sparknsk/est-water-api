...
func (m *MockEventRepo) Add(arg0 context.Context, arg1 model.WaterEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 context.Context, arg1 uint64) ([]model.WaterEvent, error) {
	m.ctrl.T.Helper()
